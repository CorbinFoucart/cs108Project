...
public class AutoQuestionMultiplication implements Question{
	 ...
	 * 
	 * IMPORTANT NOTE: because we use integer types for multiplication,
	 * MUST specify that n1Digits, n2Digits <= 4. Greater than is way
	 * too big for a multiplication question anyway.
	 * 
	 * If nDigits > 5-6 we can end up with weird results due to 
	 * the integers not being the right size.
	 * 
	 */
	public AutoQuestionMultiplication(int n1Digits, int n2Digits) {
		this.weight = 1;
		this.userAnswer = "";
		generateID();
	...
	/*
	 * create 2 rdm ints, multiply, save appropriately; only 
	 ...
	 * 
	 * Rationale for this is to get nice looking multiplcation
	 * questions such as:
	 * 
	 *      1234                         56
	 *      x 56   : rather than :   x 1234 
	 *     ------                   --------
	 *     
	 *  which I think we can all agree looks really stupid.
	 */
	...
	public String getClassName() {
		return "AutoQuestionMultiplication";
	}
