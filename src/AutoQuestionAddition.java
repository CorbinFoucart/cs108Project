...
public class AutoQuestionAddition implements Question{
	 ...
	 * 
	 */
	public AutoQuestionAddition(int n1Digits, int n2Digits) {
		this.weight = 1;
		this.userAnswer = "";
		generateID();
	...
	/*
	 * create 2 rdm ints, add, save appropriately; only 
	 ...
	 * 
	 * Rationale for this is to get nice looking addition
	 * questions such as:
	 * 
	 *      1234                         56
	 *      + 56   : rather than :   + 1234 
